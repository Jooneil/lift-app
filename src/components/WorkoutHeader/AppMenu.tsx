...
const playIcon = <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="8" r="6.5" /><polygon points="6.5,5.5 11,8 6.5,10.5" fill="currentColor" stroke="none" /></svg>;
...
export default function AppMenu({ userEmail, onPreferences, onArchive, onLogout, onReplayTutorial }: Props) {
  return (
    <MenuShell minWidth={260}>
      ...
      {onReplayTutorial && (
        <MenuRow icon={playIcon} label="Replay tutorial" sub="Walk through the basics again" onClick={onReplayTutorial} bordered />
      )}
